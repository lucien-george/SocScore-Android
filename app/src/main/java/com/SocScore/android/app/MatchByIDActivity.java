...
public class MatchByIDActivity extends AppCompatActivity {
    private ListView list_view_matches_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_match_by_id);
        setUpVariables();
        MatchAdapter matchAdapter = new MatchAdapter(matches , MatchByIDActivity.this);
        list_view_matches_id.setAdapter(matchAdapter);
    }

    public void setUpVariables()
    {
        matches = analysisViewer.getMatchesByID();
        list_view_matches_id = (ListView) findViewById(R.id.list_view_matches_id);
    }

    public void closeMatchAnalysisID(View view)
    {
